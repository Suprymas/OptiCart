...
from .views import home_view, search_view, basket_comparison, template_compare, demo_save_template, demo_chart_data, add_to_cart, remove_from_basket, save_basket_as_template, templates_view, load_template, delete_template, search_api, product_detail, product_compare, login_view, logout_view, basket_view
